...
alter table esgf_node_manager.access_logging add data_size bigint default -1;
alter table esgf_node_manager.access_logging add xfer_size bigint default -1;
